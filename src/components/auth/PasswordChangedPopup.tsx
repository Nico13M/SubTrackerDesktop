...
const PasswordChangedPopup: React.FC<Props> = ({ open, onClose }) => {
  useEffect(() => {
    if (!open) return;
          ...
          <div className="fixed top-6 right-6 z-50">
            <div className="flex items-center gap-3 rounded-lg bg-white px-4 py-3 shadow-lg">
              ...
              <div className="flex-1">
                ...
                <div className="text-sm text-muted-foreground">Votre mot de passe a été changé avec succès. Vous pouvez maintenant vous connecter.</div>
              </div>
